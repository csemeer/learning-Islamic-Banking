...
import { ArrowLeft, CheckCircle, BookOpen, Code, Lightbulb, GitCompare } from 'lucide-react';
...
export default function FlexcubeTopicView({
  moduleId,
  topicId,
  onTopicSelect,
  onBack,
  ...
  const module = flexcubeModules.find((m) => m.id === moduleId);
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-blue-100">{module.level} Level</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8">
          ...
          {currentTopic.memorization && (
            <div className="mb-6 bg-gradient-to-r from-pink-50 to-purple-50 rounded-lg p-6 border-2 border-pink-200">
              <h4 className="text-xl font-bold text-gray-800 mb-3 flex items-center gap-2">
                <Lightbulb className="text-pink-600" />
                Quick Reference
              </h4>
